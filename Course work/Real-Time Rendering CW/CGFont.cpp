...
CGFont::CGFont(const wstring& fontName, const int fontSize) {
...
void CGFont::renderText(const float x, const float y, const GUMatrix4& view, const CGColorRGB& colour, const char *formatString, ...) const {
